...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack NUCLEAR_REACTOR = new SlimefunItemStack("NUCLEAR_REACTOR", HeadTexture.NUCLEAR_REACTOR, "&2Nuclear Reactor", "", "&fRequires Cooling!", "&8⇨ &bMust be surrounded by Water", "&8⇨ &bMust be supplied with Reactor Coolant Cells", "&8⇨ &cBRMZ é noobinho", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(13107200), LoreBuilder.powerPerSecond(200000));
    public static final SlimefunItemStack NETHER_STAR_REACTOR = new SlimefunItemStack("NETHERSTAR_REACTOR", HeadTexture.NETHER_STAR_REACTOR, "&fNether Star Reactor", "", "&fRuns on Nether Stars", "&8⇨ &bMust be surrounded by Water", "&8⇨ &bMust be supplied with Nether Ice Coolant Cells", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(26214400), LoreBuilder.powerPerSecond(400000), "&8\u21E8 &4Causes nearby Entities to get Withered");
