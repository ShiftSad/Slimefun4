...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack NUCLEAR_REACTOR = new SlimefunItemStack("NUCLEAR_REACTOR", HeadTexture.NUCLEAR_REACTOR, "&2Nuclear Reactor", "", "&fRequires Cooling!", "&8\u21E8 &bMust be surrounded by Water", "&8\u21E8 &bMust be supplied with Reactor Coolant Cells", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(Slimefun.getCfg().getInt("reactor.nuclear-reactor.power-buffer")), LoreBuilder.powerPerSecond(Slimefun.getCfg().getInt("reactor.nuclear-reactor.power-per-second")));
    public static final SlimefunItemStack NETHER_STAR_REACTOR = new SlimefunItemStack("NETHERSTAR_REACTOR", HeadTexture.NETHER_STAR_REACTOR, "&fNether Star Reactor", "", "&fRuns on Nether Stars", "&8\u21E8 &bMust be surrounded by Water", "&8\u21E8 &bMust be supplied with Nether Ice Coolant Cells", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(Slimefun.getCfg().getInt("reactor.nether-star-reactor.power-buffer")), LoreBuilder.powerPerSecond(Slimefun.getCfg().getInt("reactor.nether-star-reactor.power-per-second")), "&8\u21E8 &4Causes nearby Entities to get Withered");
